...
const Navbar = ({ className, currentPath }) => {
    ...
    return (
        <div className={`${className} navbar fixed top-4 left-1/2 z-40 transform -translate-x-1/2 w-[96%] bg-white shadow-lg border-black border-[3px] rounded-lg flex justify-between items-center px-4 py-2`}>
